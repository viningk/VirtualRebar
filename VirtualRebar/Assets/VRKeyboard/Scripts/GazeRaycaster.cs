...
namespace VRKeyboard.Utils
{
    public class GazeRaycaster : MonoBehaviour
    {
        ...
        private IEnumerator FillCircle(Transform target)
        {
            ...
            if (target.GetComponent<InputField>())
            {
                target.GetComponent<InputField>().ActivateInputField();
                target.GetComponent<InputField>().Select();
        
                GameObject.Find("Keyboard").GetComponent<KeyboardManager>().inputText = target.GetComponent<InputField>();
